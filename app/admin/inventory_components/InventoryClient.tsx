...
import type ModalAddProductType    from "@/components/inventory/ModalAddProduct";
import type ModalEditProductType   from "@/components/inventory/ModalEditProduct";
import type ModalDeleteProductType from "@/components/inventory/ModalDeleteProduct";

// Lazy-load modals — chunks are only fetched when the modal first opens.
const ModalAddProduct    = dynamic(() => import("@/components/inventory/ModalAddProduct"))    as typeof ModalAddProductType;
const ModalEditProduct   = dynamic(() => import("@/components/inventory/ModalEditProduct"))   as typeof ModalEditProductType;
const ModalDeleteProduct = dynamic(() => import("@/components/inventory/ModalDeleteProduct")) as typeof ModalDeleteProductType;
...
const initialProducts: Product[] = [
  { id: 1, name: "Ethiopian Yirgacheffe", category: "Coffee Beans",      price: 18.50, stock: 42,  sku: "BN-ETH-001" },
  { id: 2, name: "Oatly Barista Edition", category: "Dairy Alternative", price:  4.20, stock: 12,  sku: "MK-OAT-004" },
  { id: 3, name: "Paper Cups (12oz)",     category: "Paper Goods",       price:  0.12, stock: 300, sku: "PG-CUP-12"  },
  { id: 4, name: "Vanilla Syrup",         category: "Syrups",            price:  8.90, stock: 18,  sku: "SY-VAN-001" },
  { id: 5, name: "Espresso Blend",        category: "Coffee Beans",      price: 16.00, stock: 8,   sku: "BN-ESP-002" },
];
    ...
    <div className="flex-1 overflow-y-auto p-4 sm:p-8 pt-4 custom-scrollbar">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {[
          ...
          { label: "Stok Menipis",  value: lowStockCount.toString(),       icon: AlertTriangle, color: "text-amber-500 bg-amber-500/10"  },
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50 dark:bg-[#231910] border-b border-gray-200 dark:border-[#3e342b]">
                ...
                <th className="py-4 px-6 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-[#8e7f72] min-w-27.5">Harga</th>
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-[#8e7f72]">SKU: {product.sku}</p>
                          </div>
                        </div>
                      </td>
